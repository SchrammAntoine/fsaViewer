...
#
#
# ANTOINE SCHRAMM MODIFICATIONS
#
# url for ABIF format documentation :
# https://projects.nfstc.org/workshops/resources/articles/ABIF_File_Format.pdf
#
# readNextpString -> force utf-8 decoding
#
import struct
import datetime
...
class ABIFReader:
    ...
    def readNextpString(self):
        ...
        chars = [ self.readNextChar().decode("utf-8") for i in range(nb)] ### modification Antoine Schramm, force UTF-8 decoding
        return ''.join(chars)
